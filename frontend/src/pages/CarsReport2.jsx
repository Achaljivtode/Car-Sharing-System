...
function CarsReports2() {
  ...
  const cars = [
    ...
    },
    {
      ...
      status: 'In Use',
      price: 35,
      features: ['Park Assist', 'Navigation', 'Bluetooth']
    },
    {
      id: 'CAR-003',
      name: 'Toyota Prius',
      ...
      status: 'In Use',
      price: 30,
      features: ['Backup Camera', 'Lane Assist', 'Smart Cruise']
    },
    {
      id: 'CAR-004',
      name: 'Audi e-tron',
      ...
      status: 'Available',
      price: 55,
      features: ['Virtual Mirrors', 'Air Suspension', 'Premium Interior']
    }
  ];
      ...
      <div className="flex-1">
        ...
        <header className="bg-white shadow-sm">
          <div className="flex items-center justify-between px-6 py-4">
            <h2 className="text-2xl font-semibold text-gray-800">Available Cars</h2>
              ...
              <div key={car.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="relative h-48">
                  ...
                  <div className="absolute top-4 right-4">
                    <div className={`flex items-center space-x-1 px-2 py-1 rounded-full bg-white/90 ${getStatusColor(car.status)}`}>
                      <Circle size={8} />
