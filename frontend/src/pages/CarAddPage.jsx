  ...
  return (
    <div>
        ...
        <div className='border-t-4 pt-10 border-t-amber-600 p-10 shadow-[1px_10px_50px_rgba(0,0,0,0.15)] max-w-7xl mx-auto my-10' >
            ...
            <h1 className='text-orange-400 my-1 text-2xl font-semibold '>ADD YOUR CAR</h1>
            <hr />
            <form action="#" className=' w-full p-5 mt-5'>
                ...
                <div className='mt-10'>
                    <input type="submit" value='ADD YOUR CAR' className='w-full font-bold bg-blue-400 p-3 rounded-md text-white hover:cursor-pointer hover:bg-blue-500' />
                </div>
            </form>
        </div>
