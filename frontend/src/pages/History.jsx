              ...
              <div key={rental.id} className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                <div className="flex">
                  <div className="p-2 w-1/4">
                    <img src={rental.car_image_url} alt={rental.car_model} className="h-[200px] w-[350px]" />
                  </div>
                  <div className="w-3/4 p-6">
                    <h3 className="text-xl font-semibold mb-2">{rental.car_model}</h3>
                    ...
                    <div className="grid grid-cols-3 gap-6 my-4">
                      <div className="flex flex-col text-lg text-gray-500">
                        Booking Date: 
                        <span className="text-gray-700 font-semibold text-xl">{rental.booking_date}</span>
                      </div>
                      <div className="flex flex-col text-lg text-gray-500">
                        Cost: 
                        <span className="text-gray-900 font-semibold text-xl">${rental.price}</span>
                      </div>
                    </div>
