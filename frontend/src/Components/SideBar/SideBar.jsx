...
function SideBar() {
  ...
  return (
    <div className="bg-gray-900 lg:h-screen lg:w-1/5 md:1/5 text-white ">
                <nav className="border w-full lg:h-screen mx-auto flex lg:flex-col items-center justify-between p-6 lg:px-8" aria-label="Global">
                    ...
                    <div className="hidden lg:flex flex-col lg:flex-1 lg:justify-end">
                        <a href="/" className="text-sm font-bold">Log Out<span aria-hidden="true"> &rarr;</span></a>
                    </div>
                </nav>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-gray-500/10">
                                    <div className="space-y-2 py-6">
                                        ...
                                        <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base/7  font-semibold text-gray-900 hover:bg-gray-50">BOOK A CAR</a>
